...
CREATE OR REPLACE STREAM "DESTINATION_SQL_STREAM" (INGEST_TIME TIMESTAMP, COUNTRY VARCHAR(16), COUNTRY_COUNT INT);
...
GROUP BY COUNTRY , STEP("SOURCE_SQL_STREAM_001".ROWTIME BY INTERVAL '10' SECOND);
